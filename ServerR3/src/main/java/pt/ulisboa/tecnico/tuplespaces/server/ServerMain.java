...
import pt.ulisboa.tecnico.tuplespaces.server.service.TupleSpacesReplicaTotalOrderServiceImpl;
...
public class ServerMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final BindableService impl = new TupleSpacesReplicaTotalOrderServiceImpl();
